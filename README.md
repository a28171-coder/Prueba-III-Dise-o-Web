...
Aplicar estilos mediante Bootstrap y CSS personalizado

Diseñar una página visualmente atractiva y fácil de usar

Organizar el contenido en diferentes secciones

Integrar un mapa de Google Maps dentro de la página

Crear un diseño adaptable a distintos dispositivos (responsive)
...
<head> para la configuración
<body> para el contenido visible
<section> para dividir la página en partes
<div> para organizar elementos
...
Organizar el contenido en columnas
Crear botones y contenedores
Mejorar la apariencia general de la web
Bootstrap se ha importado mediante CDN, por lo que no es necesario instalar nada.
